...
export const commandSchemas: Record<string, CommandSchema> = {
  ...
  "command": {
    ...
    examples: [
      ...
      { cmd: "unictl command editor_log -p action=errors", intent: "read current compile errors / exceptions from the project-scoped editor log; inspect data.freshness for compile-boundary filtering and stale omitted counts" },
