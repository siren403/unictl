...
export const commandSchemas: Record<string, CommandSchema> = {
  ...
  "build": {
    ...
    args: [
      ...
      { name: "method", type: "string", required: false, description: "Project static build method to invoke, e.g. Namespace.Type.Method." },
    ...
    examples: [
      ...
      { cmd: "unictl build --method PickUpCatBuild.Android --method-param channel=release --wait", intent: "invoke a project-defined custom static build method with lifecycle tracking" },
    ],
    exit_codes: [0, 1, 2, 3, 124, 125],
